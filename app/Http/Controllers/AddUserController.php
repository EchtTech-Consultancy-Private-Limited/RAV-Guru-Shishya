...
class AddUserController extends Controller
{
    ...
    public function manage_profile_form(Request $request)
    {
        ...
        if ($formId === 'step1') {
            ...
            'f_name.required' => 'father is required',
            'address1.required' => 'address is required',
            'address2.required' => 'address is required',
            'country.required' => 'country is required',
            'state.required' => 'state is required',
            'city.required' => 'city is required',
            'pincode.required' => 'pincode is required and must be integer',
            'per_address1.required' => 'this field is required',
            'per_address2.required' => 'this field is required',
            'per_country.required' => 'this field is required',
            'per_state.required' => 'this field is required',
            'per_city.required' => 'this field is required',
            'per_pincode.required' => 'this field is required and must be integer',
            'aadhaar_no.required' => 'aadhaar number is required and must be integer',
            'pan_no.required' => 'pan number is required last 4 digits only',
            'e_sign.required'   => 'E-signature is required jpeg,png,jpg',
            'profile_image.required|'   => 'profile is required jpeg,png,jpg',
            'mobile_no.required' => 'mobile number is required and must be integer',
