                                                            ...
                                                            <div class="form-group focused">
                                                                <div class="form-line">
                                                                    ...
                                                                    <input type="date" name="follow_up_date"
                                                                        ...
                                                                        value="@if (!empty($data->follow_up_date)) {{ date('Y-m-d', strtotime($data->follow_up_date)) }}@else{{ old('follow_up_date') }} @endif"
                                                                        required>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    ...
                                                                    <select name="report_type" id="report_type"
                                                                        ...
                                                                        <option value="Daily"
                                                                            @if (!empty($data->report_type) && $data->report_type == 'Daily') SELECTED @elseif(old('report_type') && old('report_type') == 'Daily') SELECTED @endif>
                                                                            Daily Progress </option>
                                                                        <option value="Weekly"
                                                                            @if (!empty($data->report_type) && $data->report_type == 'Weekly') SELECTED @elseif(old('report_type') && old('report_type') == 'Weekly') SELECTED @endif>
                                                                            Weekly Progress</option>
                                                                        <option value="Monthly"
                                                                            @if (!empty($data->report_type) && $data->report_type == 'Monthly') SELECTED @elseif(old('report_type') && old('report_type') == 'Monthly') SELECTED @endif>
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-sm-12 p-t-20 text-left">
                                                                <button type="submit"
                                                                    ...
                                                                    &nbsp; </button>
                                                                <a href="{{ url('/follow-up-patients') }}"><button
                                                                        type="button"
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <br><label for="example-text-input"
                                                            class="form-control-label"><strong>{{ $patient->main_complaintsaid_by_patient }}</strong></label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if (!empty($shishya->id))
                                                            @if ($shishya->e_sign != '')
                                                                <img src="{{ asset('uploads/' . $shishya->e_sign) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if (!empty($guru->id))
                                                            @if ($guru->e_sign != '')
                                                                <img src="{{ asset('uploads/' . $guru->e_sign) }}"
                                                                    alt="E-Sign" width="100px;" height="80px;">
                                                            @endif
                                                            <br>
                                                            (@if ($guru->title > 0)
