                                                            ...
                                                            <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <label for="progress"
                                                                            ...
                                                                            value=""
                                                                            aria-label="progress"
                                                                            placeholder="Please enter progress" required>@if(!empty($data->progress)){{$data->progress}}@else{{ old('progress') }}@endif</textarea>
                                                                            @error('progress')
                                                                                 <span class="invalid-feedback" role="alert">
                                                                                    <strong>{{ $message }}</strong>
                                                                                 </span>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <label for="treatment"
                                                                            ...
                                                                            placeholder="Please enter treatment/therapies" required>@if(!empty($data->treatment)){{$data->treatment}}@else{{ old('treatment') }}@endif</textarea>
                                                                            @error('treatment')
                                                                                 <span class="invalid-feedback" role="alert">
                                                                                    <strong>{{ $message }}</strong>
                                                                                 </span>
