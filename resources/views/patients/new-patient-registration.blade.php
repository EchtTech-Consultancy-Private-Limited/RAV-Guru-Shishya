                                    ...
                                    <input type="text" name="prno" class="form-control" value="@if(request()->prno){{request()->prno}}@endif" maxlength="20" >
                                       ...
                                       <button type="submit"   class="btn btn-primary waves-effect" style="line-height:2;" > Filter </button>
                                        ...
                                        <li >
                                         ...
                                         @else
                                          <a type="button" onclick="add_phr_func()" class="btn btn-danger waves-effect" style="line-height:2;">+ Add PHR</a>
                                         @endif
                                        </li>
                           ...
                           <div class="col-sm-12">
                              <form role="form" method="POST" action="{{ url('/send-php-to-guru') }}">
                                  ...
                                  <table class="table table-hover js-basic-example contact_list dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                       <thead>
                                          <tr role="row">
                                             <th class="center sorting sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label=" No : activate to sort column descending"> <input id="addall" type="checkbox"><label for='selectAll'> </label> </th>
                                       ...
                                       <tbody>
                                          ...
                                          <tr class="gradeX odd @if($patientlist->read_by_shishya=='0') active-row @endif">
                                                  ...
                                                  <td class="center sorting_1"><input name="send_phr_to_guru[]" value="{{ $patientlist->id }}" type="checkbox"  class="add" ></td>
