                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <ul class="breadcrumb breadcrumb-style">
                        <li class="breadcrumb-item">
                            <h6 class="page-title"> @if(request()->path()=="patients/In-Patient") In Patients
                                @elseif(request()->path()=="patients/OPD-Patient") OPD Patients
                                @elseif(request()->path()=="admin-patient-list") Patients @endif </h6>
                        ...
                        <li class="breadcrumb-item active"> @if(request()->path()=="patients/In-Patient") In Patients
                            @elseif(request()->path()=="patients/OPD-Patient") OPD Patients
                            @elseif(request()->path()=="admin-patient-list") Patients @endif </li>
                    </ul>
                    ...
                    <div class="row align-items-center">                       
                        <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                            <div class="form-group d-inline-block ">
                                <label class="active">Select Month:<span class="text-danger"></span></label>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                            <div class="form-group ">
                                <label class="active">Select Year:<span class="text-danger"></span></label>
                        ...
                        <div class="col-xl-3  col-md-3  d-flex justify-content-left">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        aria-label="Created Date : activate to sort column ascending">
                                                        Gender <i class="fa fa-long-arrow-up" aria-hidden="true"></i> <i
                                                            class="fa fa-long-arrow-down" aria-hidden="true"></i> </th>

                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        aria-label=" User Type : activate to sort column ascending">
                                                        Reg. Date <i class="fa fa-long-arrow-up" aria-hidden="true"></i>
                                                        <i class="fa fa-long-arrow-down" aria-hidden="true"></i> </th>
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        aria-label="Created Date : activate to sort column ascending">
                                                        Action <i class="fa fa-long-arrow-up" aria-hidden="true"></i> <i
                                                            class="fa fa-long-arrow-down" aria-hidden="true"></i> </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr
                                                    ...
                                                    <td class="center text-nowrap"> {{$patientlist->patient_name}} </td>
                                                    <td class="center"> {{$patientlist->patient_type}} </td>
                                                    <td class="center">@if($patientlist->gender==1) Male
                                                        @elseif($patientlist->gender==2) Female
                                                        @elseif($patientlist->gender==3)Others @endif</td>
                                                    ...
                                                    <td class="center">
                                                        @if(permissionCheck()->view == 3 || Auth::user()->user_type ==
                                                        4)
                                                        ...
                                                        @endif
                                                        @if(permissionCheck()->edit == 2 || Auth::user()->user_type ==
                                                        4)
                                                        <a href="{{ url('patients/admin-edit-patient/'.$patientlist->id) }}"
                                                            class="btn edit btn-tbl-edit" title="Edit Patient">
                                       ...
                                       <i class="material-icons">delete_forever</i>
                                                        ...
                                                        @if(permissionCheck()->delete == 4 || Auth::user()->user_type ==
                                                        4)
                                                        <a class="btn delete btn-tbl-delete delete_patient"
                                                            data-id="{{$patientlist->id}}" data-bs-toggle="modal"
                                                            data-bs-target="#delete_modal" title="Patient Delete">
                                                            <i class="material-icons">delete_forever</i>
                                                        </a>
                                                        @endif
                                                        <a target="_self"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('delete-patient-remark') }}" method="POST"
                                                ...
                                                @csrf
                                                <input type="hidden" name="patient_id" class="form-control capitalize"
                                                    id="patient_id">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="delete_remark" name="delete_remark" rows="6"
                                                                cols="25" maxlength="250" required></textarea>
