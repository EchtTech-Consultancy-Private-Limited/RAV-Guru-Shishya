...
@if (count($errors) > 0)
                  ...
                  <h2>
                     ...
                     <ul style="float:right; overflow:hidden;">
                                       ...
                                       <li style="float:left;clear:none; margin:10px;">From:
                                        ...
                                        <li style="float:left;clear:none; margin:10px;"> 
                                          <a type="button" href="javascript:void(0);" onclick="javascript:export_excel('{{url('/export-attendance')}}');"   class="btn btn-danger waves-effect" style="line-height:2;" > Download </a>
                                        </li>
     ...
     <script>
      function export_excel(url){
        $("#frmattendances").attr('action', url);
        $("#frmattendances").submit();
      }
     </script>
