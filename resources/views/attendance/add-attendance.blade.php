                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class=" default-select select2Style">
                                            <div class="form-group">
                                                <label class="active">Morning Shifts Timings :<span
                                                        class="text-danger"></span></label>
                                                <select class="form-control select2 width" multiple=""
                                                    data-placeholder="Select" name="attendance_morning_timing[]">
                                                    ...
                                                    <option @if(in_array($value, old('attendance_morning_timing')))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="active">Evening Shifts Timings :<span
                                                    class="text-danger"></span></label>
                                            <select class="form-control select2 width" multiple=""
                                                data-placeholder="Select" name="attendance_evening_timing[]">
                                                <option value="">Select Morning Timing</option>
                                                @foreach(__('phr.attendance_evening_timing') as $key=>$value)
                                                @if(old('attendance_evening_timing'))
                                                <option @if(in_array($value, old('attendance_evening_timing'))) selected
                                ...
                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="attendance" class="form-control active" required>
                                            ...
                                            @if(old('attendance'))
                                            <option value="{{ old('attendance') }}" selected>{{ old('attendance') }}
                                            </option>
                                            @endif
