            ...
            <form method="POST" action="{{ url('update-rasayoga-details') }}" id="add_rasayoga_details">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <div class="form-group  ">
                            ...
                            <h5 class="d-block text-left">
                                Reference
                                <p class=' text-xs pt-1'>Text, Chapter, Sloka – to – (Published
                                    by Edition, Writer/Translator)</p>
                            </h5>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12 ">
                                <div class="card">
                                    <div class="card-body p-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $drugrasaparts->name_of_the_ingredients_mineral_metal }}"
                                                                maxlength="200">
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                value="{{ $drugrasaparts->rasa_part_used }}"
                                                                maxlength="100">
                                                        ...
                                                        <td class="text-warning mt-10">
                                                            <input type="text" name="quantity[]"
                                                                ...
                                                                value="{{ $drugrasaparts->rasa_quantity }}"
                                                                maxlength="10">
                                                            @error('quantity')
                                                            <p class='text-danger text-xs pt-1'>
                                                                {{ $message }} </p>
                                                        ...
                                                        <td class="mt-10">
                                                            <a href="{{ url('delete-rasayoga-part/'.$drugrasaparts->id) }}"
                                        ...
                                        <div style="float:right;"><button onclick="addfaqs();"
                                                type="button" class="btn add btn-success"><i
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                class="form-control-label @if(isset($data->herbal_first)) patient-highlight @endif"
                                ...
                                1</label>
                            <input type="text" name="herbal_first" class="form-control"
                                value="{{ $rasadrug->herbal_first }}">@error('herbal_first')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label
                                class="form-control-label @if(isset($data->herbal_second)) patient-highlight @endif"
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                2</label>
                            <input type="text" name="herbal_second" class="form-control"
                                value="{{ $rasadrug->herbal_second }}">
                            @error('herbal_second')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                class="form-control-label @if(isset($data->mineral_first)) patient-highlight @endif"
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                1</label>
                            <input type="text" name="mineral_first" class="form-control"
                                value="{{ $rasadrug->mineral_first }}">@error('mineral_first')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label
                                class="form-control-label @if(isset($data->mineral_second)) patient-highlight @endif"
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                2</label>
                            <input type="text" name="mineral_second" class="form-control"
                                placeholder=" " value="{{ $rasadrug->mineral_second }}">
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                class="form-control-label @if(isset($data->metal_first)) patient-highlight @endif"
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                1</label>
                            <input type="text" name="metal_first" class="form-control"
                                aria-label="Step 1"
                                value="{{ $rasadrug->metal_first }}">@error('metal_first')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                ...
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                2</label>
                            <input type="text" name="metal_second" class="form-control"
                                aria-label="Step 2" value="{{ $rasadrug->metal_second }}">
                            @error('metal_second')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                class="form-control-label @if(isset($data->animal_first)) patient-highlight @endif"
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                1</label>
                            <input type="text" name="animal_first" class="form-control"
                                aria-label="Step 1"
                                value="{{ $rasadrug->animal_first }}">@error('animal_first')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                class="form-control-label @if(isset($data->animal_second)) patient-highlight @endif"
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                2</label>
                            <input type="text" name="animal_second" class="form-control"
                                aria-label="Step 2" value="{{ $rasadrug->animal_second }}">
                            @error('animal_second')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                class="form-control-label @if(isset($data->bhavana_dravayas_first)) patient-highlight @endif"
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                1</label>
                            <input type="text" name="bhavana_dravayas_first"
                                class="form-control" aria-label="Step 1"
                                value="{{ $rasadrug->bhavana_dravayas_first }}">@error('bhavana_dravayas_first')
                            <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6 col-6">
                        <div class="form-group">
                            <label for="example-text-input"
                                ...
                                title="Updated by @if(@$drugHistoryLog->user_type == '1')Admin @elseif(@$drugHistoryLog->user_type == '2')Guru @else (@$drugHistoryLog->user_type == '3')Shishya @endif">Step
                                2</label>
                            <input type="text" name="bhavana_dravayas_second"
                                class="form-control" aria-label="Step 2"
                                value="{{ $rasadrug->bhavana_dravayas_second }}">
...
function addfaqs() {
    ...
    html +=
        '<td><input type="text" name="name_of_the_ingredients_mineral_metal[]" class="form-control" placeholder="Enter quantity" aria-label="quantity" value="" maxlength="200"></td>';
    html +=
