				                     ...
				                     <div class="row">
				                        ...
				                        <div class="col-sm-12 col-md-6">
				                           ...
				                           <div class="form-group">
				                              ...
				                              <input type="text"  name="firstname"  class="form-control capitalize" value="guru" placeholder="First Name" >
				                           </div>
				                        </div>
				                     </div>
				                     <div class="row">
				                        <div class="col-sm-12 col-md-6">
				                           <div class="form-group">
				                              ...
				                              <input type="text" name="middlename" class="form-control capitalize" placeholder="Middle Name"  value="" >
				                           </div>
				                        </div>
				                        <!-- student name -->
				                        <div class="col-sm-12 col-md-6">
				                           ...
				                           <div class="form-group">
				                              ...
				                              <input type="text" name="lastname" class="form-control capitalize" placeholder="Last Name" value="" >
				                           </div>
				                        </div>
				                     </div>
				                     <div class="row">
